                    ...
                    {filteredArticles.map(({id, date, author, title, tags, blurb}) => (
                        <div className="break-inside h-min w-full max-w-sm overflow-visible rounded-lg mx-auto">
                            <Link href={`/posts/${id}`} legacyBehavior>
                                <a className="block max-w-sm p-3 bg-white border border-slate-700 rounded-lg shadow-md hover:shadow-none hover:bg-gray-100 hover:no-underline dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
